...

{
    ...
    "category": "function",
    "text": "gaussian(n, σ)\n\nGives an n-sample gaussian window defined by sampling the function w(x) = e^-frac 1 2 left(frac x σ right)^2 in the range -0505. This means that for σ=05 the endpoints of the window will correspond to 1 standard deviation away from the center.\n\n\n\n\n\n"
},
