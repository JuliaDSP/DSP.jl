...
@testset "`mt_cross_power_spectra`" begin
    ...
    csd_array_multitaper_frequencies = read_reference_data("csd_array_multitaper_frequencies.txt", '\n')
    csd_array_multitaper_values_re = reshape(read_reference_data("csd_array_multitaper_values_re.txt", '\n'), (2,2,512))
